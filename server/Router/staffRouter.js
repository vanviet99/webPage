...
router.patch('/putstaff',middlewreController.verifyTokenAndAdmin,staff.putstaff)
router.delete('/delstaff/:staffId',middlewreController.verifyTokenAndAdmin,staff.delstaff)
